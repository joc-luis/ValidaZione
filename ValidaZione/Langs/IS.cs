...
public string DoesNotEndWith(List<string> values)
        {
            return $"{FieldName} má ekki enda á einu af eftirfarandi: {String.Join(", ", values)}.";
        }
public string DoesNotStartWith(List<string> values)
        {
            return $"{FieldName} mega ekki byrja á einu af eftirfarandi: {String.Join(", ", values)}.";
        }
public string Email()
        {
...
public string RequiredIf(string name, string value)
        {
            return $"Reiturinn {FieldName} er nauðsynlegur þegar {name} er {value}.";
        }
